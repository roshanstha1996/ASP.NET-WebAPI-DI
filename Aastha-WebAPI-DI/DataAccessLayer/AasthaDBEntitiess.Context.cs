...
namespace DataAccessLayer
{
    ...
    public partial class AasthaDBEntities : DbContext
    {
        ...
        public DbSet<SubCategoryTable> SubCategoryTables { get; set; }
        ...
        public virtual int ManageSCT(Nullable<int> salesCodeId, string customerName, Nullable<System.DateTime> salesDate, string customerEmail, string contactNumber, string address, Nullable<int> mode)
        {
            var salesCodeIdParameter = salesCodeId.HasValue ?
                new ObjectParameter("SalesCodeId", salesCodeId) :
                new ObjectParameter("SalesCodeId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ManageSCT", salesCodeIdParameter, customerNameParameter, salesDateParameter, customerEmailParameter, contactNumberParameter, addressParameter, modeParameter);
        }
    
        public virtual int ManageST(Nullable<int> salesId, Nullable<int> salesCodeId, string productId, Nullable<int> salesQuantity, Nullable<int> mode)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ManageST", salesIdParameter, salesCodeIdParameter, productIdParameter, salesQuantityParameter, modeParameter);
        }
        ...
        public virtual int SP_ManageSubCategory(Nullable<int> subCategoryId, Nullable<int> categoryId, string subCategoryName, string description, Nullable<int> mode)
        {
            var subCategoryIdParameter = subCategoryId.HasValue ?
                new ObjectParameter("SubCategoryId", subCategoryId) :
                new ObjectParameter("SubCategoryId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_ManageSubCategory", subCategoryIdParameter, categoryIdParameter, subCategoryNameParameter, descriptionParameter, modeParameter);
        }
    }
}
